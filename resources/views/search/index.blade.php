                            ...
                            <ul class="pagination pagination-primary-soft d-inline-block d-md-flex rounded mb-0">
                                @if ($lessons->currentPage() > 1)
                                    <li class="page-item mb-0">
                                        <a class="page-link" href="{{ url('/search?page=' . ($lessons->currentPage() - 1) . '&search=' . request('search')) }}" tabindex="">
                                ...
                                @for ($i = 1; $i <= $lessons->lastPage(); $i++)
                                    <li class="page-item mb-0 {{ $lessons->currentPage() == $i ? 'active' : '' }}">
                                        <a class="page-link" href="{{ url('/search?page=' . $i . '&search=' . request('search')) }}">{{ $i }}</a>
                                    </li>
                                @endfor
                                @if ($lessons->currentPage() < $lessons->lastPage())
                                    <li class="page-item mb-0">
                                        <a class="page-link" href="{{ url('/search?page=' . ($lessons->currentPage() + 1) . '&search=' . request('search')) }}">
