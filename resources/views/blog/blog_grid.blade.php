                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="{{ asset('images/news/' . $item->image) }}" class="card-img" alt="{{$item->name}}">
                            <!-- Overlay -->
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title"><a href="{{ route('news.detail', ['id' => $item->id])}}">{{$item->name}}</a></h5>
                            <p class="text-truncate-2">{{$item->description}}</p>
                            <!-- Info -->
                            <div class="d-flex justify-content-between">
                                <h6 class="mb-0"><a href="#"></a></h6>
                                <span class="small"><i class="fas fa-eye"></i> {{$item->is_views}} lượt xem</span>
                            </div>
                        </div>
                    </div>
                </div>
