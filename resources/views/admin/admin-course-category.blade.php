                ...
                <div class="d-flex align-items-center w-100">
                    ...
                    <div class="d-flex align-items-center d-xl-none">
                        <a class="navbar-brand" href="index.html">
                            <img class="light-mode-item navbar-brand-item h-30px" src="assets/user/images/logo-mobile.svg"
                                alt="">
                            <img class="dark-mode-item navbar-brand-item h-30px" src="assets/user/images/logo-mobile-light.svg"
                                alt="">
                        </a>
                    </div>
                    <!-- Logo END -->
                        ...
                        <ul class="navbar-nav flex-row align-items-center">
                                                        ...
                                                        <div class="me-3">
                                                            <div class="avatar avatar-md">
                                                                <img class="avatar-img rounded-circle"
                                                                    src="assets/user/images/avatar/08.jpg" alt="avatar">
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <li>
                                                    <a href="#"
                                                        ...
                                                        <div class="me-3">
                                                            <div class="avatar avatar-md">
                                                                <img class="avatar-img rounded-circle"
                                                                    src="assets/user/images/avatar/02.jpg" alt="avatar">
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <li>
                                                    <a href="#"
                                                        ...
                                                        <div class="me-3">
                                                            <div class="avatar avatar-md">
                                                                <img class="avatar-img rounded-circle"
                                                                    src="assets/user/images/avatar/05.jpg" alt="avatar">
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <li>
                                                    <a href="#"
                                                        ...
                                                        <div class="me-3">
                                                            <div class="avatar avatar-md">
                                                                <img class="avatar-img rounded-circle"
                                                                    src="assets/user/images/avatar/03.jpg" alt="avatar">
                                                            </div>
                                                        </div>
                                                        <div>
                            ...
                            <li class="nav-item ms-2 ms-md-3 dropdown">
                                ...
                                <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button"
                                    ...
                                    aria-expanded="false">
                                    <img class="avatar-img rounded-circle" src="assets/user/images/avatar/01.jpg"
                                        alt="avatar">
                                </a>
        ...
        <div class="page-content-wrapper border">
            ...
            <div class="row mb-3">
                <div class="col-12 d-sm-flex justify-content-between align-items-center">
                    <h1 class="h3 mb-2 mb-sm-0">Web design <span
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="assets/user/images/courses/4by3/08.jpg" class="rounded"
                                                    alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="table-responsive-title mb-0 ms-2">
                                                <a href="#" class="stretched-link">Building Scalable APIs with
                                                    GraphQL</a>
                                            </h6>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="avatar avatar-xs flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="assets/user/images/avatar/09.jpg"
                                                    alt="avatar">
                                            </div>
                                            <!-- Info -->
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="assets/user/images/courses/4by3/10.jpg" class="rounded"
                                                    alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="table-responsive-title mb-0 ms-2">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Avatar -->
                                            <div class="avatar avatar-xs flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="assets/user/images/avatar/04.jpg"
                                                    alt="avatar">
                                            </div>
                                            <!-- Info -->
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="assets/user/images/courses/4by3/02.jpg" class="rounded"
                                                    alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="table-responsive-title mb-0 ms-2">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Avatar -->
                                            <div class="avatar avatar-xs flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="assets/user/images/avatar/05.jpg"
                                                    alt="avatar">
                                            </div>
                                            <!-- Info -->
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="assets/user/images/courses/4by3/04.jpg" class="rounded"
                                                    alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="table-responsive-title mb-0 ms-2">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Avatar -->
                                            <div class="avatar avatar-xs flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="assets/user/images/avatar/06.jpg"
                                                    alt="avatar">
                                            </div>
                                            <!-- Info -->
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="assets/user/images/courses/4by3/09.jpg" class="rounded"
                                                    alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="table-responsive-title mb-0 ms-2">
                                                <a href="#" class="stretched-link">JavaScript: Full
                                                    Understanding</a>
                                            </h6>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Avatar -->
                                            <div class="avatar avatar-xs flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="assets/user/images/avatar/08.jpg"
                                                    alt="avatar">
                                            </div>
                                            <!-- Info -->
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="assets/user/images/courses/4by3/11.jpg" class="rounded"
                                                    alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="table-responsive-title mb-0 ms-2">
                                                <a href="#" class="stretched-link">Build Responsive Websites with
                                                    HTML</a>
                                            </h6>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Avatar -->
                                            <div class="avatar avatar-xs flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="assets/user/images/avatar/02.jpg"
                                                    alt="avatar">
                                            </div>
                                            <!-- Info -->
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="assets/user/images/courses/4by3/12.jpg" class="rounded"
                                                    alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="table-responsive-title mb-0 ms-2">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Avatar -->
                                            <div class="avatar avatar-xs flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="assets/user/images/avatar/03.jpg"
                                                    alt="avatar">
                                            </div>
                                            <!-- Info -->
                                            <div class="ms-2">
