...
@section('contentadmin')
    ...
    <div class="page-content-wrapper border">
        ...
        <h1 class="h3 mb-3">Edit Tin tức</h1>
                            ...
                            <div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" name="description" rows="2" placeholder="Enter keywords">{{$news->description}}
                                        </textarea>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div
                                            ...
                                            <!-- Image -->
                                            <img src="{{ asset('images/news/' . $news->image) }}" class="h-50px"
                                                alt="">
                                            <div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="bg-light border border-bottom-0 rounded-top py-3" id="quilltoolbar">
                                            <textarea id="my-editor" name="content">{{$news->content}}</textarea>
