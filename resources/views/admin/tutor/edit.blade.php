...
@section('contentadmin')
    <div class="page-content-wrapper border">
        ...
        <form class="row" action="{{ route('tutor.update', $tutor->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            <div class="form-group col-lg-4">
                <label for="name">Họ gia sư</label>
                <input type="text" name="last_name" class="form-control" value="{{ $tutor->last_name }}">
                @error('last_name')
            ...
            <div class="form-group col-lg-4">
                ...
                <input type="text" name="first_name" class="form-control" value="{{ $tutor->first_name }}">
                @error('first_name')
                    <span class="invalid-feedback" role="alert">
                        <label class="error" id="name_error" for="name">{{ $message }}</label>
                    </span>
            ...
            <div class="form-group col-lg-4">
                <label for="name">Email (Lưu ý: đây là email để đang nhập tài khoản)</label>
            ...
            <div class="form-group col-lg-4 pt-4">
                <label for="file" class="labelFile">
                    ...
                    <div id="svg-none">
                        ...
                        <img  src="{{ asset('images/tutor/' . $tutor->image) }}" alt="Preview Image"
            ...
            <div class="col-lg-8 pt-2">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input type="number" name="phone_number" class="form-control" value="{{ $tutor->phone_number }}">
                        @error('phone_number')
                            <span class="invalid-feedback" role="alert">
                                <label class="error" id="name_error" for="name">{{ $message }}</label>
                            </span>
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="gender" id="gender" class="form-control">
                            <option value="0" {{ old('gender', $tutor->gender ?? '') == '0' ? 'selected' : '' }}>Nam</option>
                            <option value="1" {{ old('gender', $tutor->gender ?? '') == '1' ? 'selected' : '' }}>Nữ</option>
                            <option value="2" {{ old('gender', $tutor->gender ?? '') == '2' ? 'selected' : '' }}>Khác</option>
                        </select>
                        @error('gender')
                            <span class="invalid-feedback" role="alert">
                                <label class="error" id="gender_error" for="gender">{{ $message }}</label>
                            </span>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="address" class="form-control " value="{{ $tutor->address }}">
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <label class="error" id="name_error" for="name">{{ $message }}</label>
                            </span>
            ...
            <div class="col-lg-4 pt-2">
                ...
                <input type="text" name="subjects" class="form-control " value="{{ $tutor->subjects }}">
                @error('subjects')
                    <span class="invalid-feedback" role="alert">
                        <label class="error" id="name_error" for="name">{{ $message }}</label>
                    </span>
            ...
            <div class="col-lg-4 pt-2">
                ...
                <input type="number" name="hourly_rate" class="form-control " value="{{ $tutor->hourly_rate }}">
                @error('hourly_rate')
                    <span class="invalid-feedback" role="alert">
                        <label class="error" id="name_error" for="name">{{ $message }}</label>
                    </span>
            ...
            <div class="col-lg-12 pt-2">
                <textarea name="bio" id="content" cols="30" rows="10">{{ old('bio', $tutor->bio ?? '') }}</textarea>
