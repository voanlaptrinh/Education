                    ...
                    <div class="row g-3 align-items-center justify-content-between">
                        ...
                        <div class="col-md-12">
                            <form class="rounded position-relative" action="{{ route('contact.admin') }}" method="get">
                                <input name="query" value="{{ $searchQuery }}" class="form-control bg-body"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    ...
                                                    <h6 class="table-responsive-title mb-0 ms-2">
                                                        <a class="stretched-link">{{ $contact->name }}</a>
                                                    </h6>
                                                </div>
                                            </td>
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    <div class="ms-2">
                                                        <h6 class="mb-0 fw-light">
                                                            {{ $contact->created_at->format(' H:i:s d/m/Y') }}</h6>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#classModal2" data-action="add"
                                                    data-class-id="{{ $contact->id }}" id="detailsBtn">
                                                    Chi tiết
                                                </button>
