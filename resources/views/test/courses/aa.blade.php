                                ...
                                <div class="card bg-transparent border rounded-3 mb-1">
                                    <div id="stepper" class="bs-stepper stepper-outline">
                                        ...
                                        <div class="card-header bg-light border-bottom px-lg-5">
                                            ...
                                            <div class="bs-stepper-header aa" role="tablist">
                                                ...
                                                <div class="step" data-target="#step-4">
                                                    <div class="d-grid text-center align-items-center">
                                                        <button type="button" class="btn btn-link step-trigger mb-0"
                                                            role="tab" id="steppertrigger4" aria-controls="step-4"
                                                            aria-selected="false">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="text-danger text-end mb-0"><i
                                                    class="bi bi-clock-history me-2"></i>Time Left: 00:01:30</h6>
                                                ...
                                                <form>
                                                    ...
                                                    <div id="step-1" role="tabpanel"
                                                        ...
                                                        <div class="vstack gap-2">
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option1">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option1">We have cybersecurity insurance
                                                                    coverage</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option2">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option2">Our dedicated staff will protect
                                                                    us</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                    ...
                                                    <div id="step-2" role="tabpanel"
                                                        class="content fade dstepper-none"
                                                        ...
                                                        <div class="vstack gap-2">
                                                            ...
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option11">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option11">We have cybersecurity insurance
                                                                    coverage</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option22">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option22">Our dedicated staff will protect
                                                                    us</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option33">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option33">We give regular training for best
                                                                    practices</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option44">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option44">Third-party vendor protection</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="vstack gap-2">
                                                            ...
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option111">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option111">We have cybersecurity insurance
                                                                    coverage</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option222">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option222">Our dedicated staff will protect
                                                                    us</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option333">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option333">We give regular training for best
                                                                    practices</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option444">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option444">Third-party vendor protection</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="step-4" role="tabpanel"
                                                        ...
                                                        <div class="vstack gap-2">
                                                            ...
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option1111">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option1111">We have cybersecurity insurance
                                                                    coverage</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option2222">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option2222">Our dedicated staff will protect
                                                                    us</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option3333">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option3333">We give regular training for best
                                                                    practices</label>
                                                            </div>
                                                            <!-- Feed ques item -->
                                                            <div>
                                                                <input type="radio" class="btn-check" name="ques"
                                                                    id="option4444">
                                                                <label class="btn btn-outline-primary w-100"
                                                                    for="option4444">Third-party vendor protection</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-center mt-3">
                                                            <button type="button"
                                                                class="btn btn-success next-btn mb-0">View result</button>
                                                        </div>
